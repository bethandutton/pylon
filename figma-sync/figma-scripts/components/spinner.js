// Spinner — Figma Component — Generated by figma-sync
...
(async () => {
  ...
  if (components.length > 1) {
    ...
    components[0].name = "Spinner";
  }

  figma.notify("✓ Spinner: 3 variants created");
  figma.closePlugin();
})();
