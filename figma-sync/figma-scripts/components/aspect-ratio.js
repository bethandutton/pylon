// Aspect Ratio — Figma Component — Generated by figma-sync
...
(async () => {
  ...
  if (components.length > 1) {
    ...
    components[0].name = "Aspect Ratio";
  }

  figma.notify("✓ Aspect Ratio: 1 variants created");
  figma.closePlugin();
})();
