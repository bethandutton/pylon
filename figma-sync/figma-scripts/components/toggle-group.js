// Toggle Group — Figma Component — Generated by figma-sync
...
(async () => {
  ...
  if (components.length > 1) {
    ...
    components[0].name = "Toggle Group";
  }

  figma.notify("✓ Toggle Group: 6 variants created");
  figma.closePlugin();
})();
