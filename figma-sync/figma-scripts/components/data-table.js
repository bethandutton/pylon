// Data Table — Figma Component — Generated by figma-sync
...
(async () => {
  ...
  if (components.length > 1) {
    ...
    components[0].name = "Data Table";
  }

  figma.notify("✓ Data Table: 4 variants created");
  figma.closePlugin();
})();
