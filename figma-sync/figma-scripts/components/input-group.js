// Input Group — Figma Component — Generated by figma-sync
...
(async () => {
  ...
  if (components.length > 1) {
    ...
    components[0].name = "Input Group";
  }

  figma.notify("✓ Input Group: 3 variants created");
  figma.closePlugin();
})();
