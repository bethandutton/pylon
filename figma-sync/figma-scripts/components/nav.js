// Nav — Figma Component — Generated by figma-sync
...
(async () => {
  ...
  // Type=Active, State=Default
  {
    const node = figma.createComponent();
    node.name = "Type=Active, State=Default";
  ...
  // Type=Active, State=Hover
  {
    const node = figma.createComponent();
    node.name = "Type=Active, State=Hover";
    node.layoutMode = "VERTICAL";
    node.primaryAxisSizingMode = "AUTO";
    node.counterAxisSizingMode = "AUTO";
    node.itemSpacing = 4;
  ...
  // Type=Active, State=Selected
  {
    const node = figma.createComponent();
    node.name = "Type=Active, State=Selected";
    node.layoutMode = "VERTICAL";
    node.primaryAxisSizingMode = "AUTO";
    node.counterAxisSizingMode = "AUTO";
    node.itemSpacing = 4;
  ...
  // Type=Active, State=Focused
  {
    const node = figma.createComponent();
    node.name = "Type=Active, State=Focused";
    node.layoutMode = "VERTICAL";
    node.primaryAxisSizingMode = "AUTO";
    node.counterAxisSizingMode = "AUTO";
    node.itemSpacing = 4;
  ...
  if (components.length > 1) {
    ...
    components[0].name = "Nav";
  }

  figma.notify("✓ Nav: 4 variants created");
  figma.closePlugin();
})();
