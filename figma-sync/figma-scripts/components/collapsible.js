// Collapsible — Figma Component — Generated by figma-sync
...
(async () => {
  ...
  if (components.length > 1) {
    ...
    components[0].name = "Collapsible";
  }

  figma.notify("✓ Collapsible: 7 variants created");
  figma.closePlugin();
})();
