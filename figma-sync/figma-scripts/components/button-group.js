// Button Group — Figma Component — Generated by figma-sync
...
(async () => {
  ...
  if (components.length > 1) {
    ...
    components[0].name = "Button Group";
  }

  figma.notify("✓ Button Group: 4 variants created");
  figma.closePlugin();
})();
