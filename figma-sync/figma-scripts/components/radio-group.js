// Radio Group — Figma Component — Generated by figma-sync
...
(async () => {
  ...
  if (components.length > 1) {
    ...
    components[0].name = "Radio Group";
  }

  figma.notify("✓ Radio Group: 3 variants created");
  figma.closePlugin();
})();
