// Date Picker — Figma Component — Generated by figma-sync
...
(async () => {
  ...
  if (components.length > 1) {
    ...
    components[0].name = "Date Picker";
  }

  figma.notify("✓ Date Picker: 8 variants created");
  figma.closePlugin();
})();
