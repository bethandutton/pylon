// Separator — Figma Component — Generated by figma-sync
...
(async () => {
  ...
  // Type=With-text
  {
    ...
    node.name = "Type=With-text";
    const fillVar = await findColorVar("color-border");
    if (fillVar) {
  ...
  if (components.length > 1) {
    ...
    components[0].name = "Separator";
  }

  figma.notify("✓ Separator: 1 variants created");
  figma.closePlugin();
})();
