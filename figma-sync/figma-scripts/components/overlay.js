// Overlay — Figma Component — Generated by figma-sync
...
(async () => {
  ...
  if (components.length > 1) {
    ...
    components[0].name = "Overlay";
  }

  figma.notify("✓ Overlay: 3 variants created");
  figma.closePlugin();
})();
