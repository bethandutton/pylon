// Table — Figma Component — Generated by figma-sync
...
(async () => {
  ...
  // Type=Striped, State=Default
  {
    const node = figma.createComponent();
    node.name = "Type=Striped, State=Default";
    ...
    text.fontSize = 15;
    text.characters = "Table";
    node.appendChild(text);
    components.push(node);
  }

  // Type=Striped, State=Hover
  {
    const node = figma.createComponent();
    node.name = "Type=Striped, State=Hover";
    const fillVar = await findColorVar("color-surface");
    if (fillVar) {
      const fillPaint = figma.variables.setBoundVariableForPaint({ type: "SOLID", color: {r:0,g:0,b:0} }, "color", fillVar);
      node.fills = [fillPaint];
  ...
  // Type=Striped, State=Selected
  {
    const node = figma.createComponent();
    node.name = "Type=Striped, State=Selected";
    const fillVar = await findColorVar("color-surface");
    if (fillVar) {
      const fillPaint = figma.variables.setBoundVariableForPaint({ type: "SOLID", color: {r:0,g:0,b:0} }, "color", fillVar);
      node.fills = [fillPaint];
  ...
  // Type=Striped, State=Focused
  {
    const node = figma.createComponent();
    node.name = "Type=Striped, State=Focused";
    const fillVar = await findColorVar("color-surface");
    if (fillVar) {
      const fillPaint = figma.variables.setBoundVariableForPaint({ type: "SOLID", color: {r:0,g:0,b:0} }, "color", fillVar);
      node.fills = [fillPaint];
  ...
  if (components.length > 1) {
    ...
    components[0].name = "Table";
  }

  figma.notify("✓ Table: 4 variants created");
  figma.closePlugin();
})();
