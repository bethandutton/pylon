// Context Menu — Figma Component — Generated by figma-sync
...
(async () => {
  ...
  if (components.length > 1) {
    ...
    components[0].name = "Context Menu";
  }

  figma.notify("✓ Context Menu: 4 variants created");
  figma.closePlugin();
})();
