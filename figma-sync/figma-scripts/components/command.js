// Command — Figma Component — Generated by figma-sync
...
(async () => {
  ...
  if (components.length > 1) {
    ...
    components[0].name = "Command";
  }

  figma.notify("✓ Command: 8 variants created");
  figma.closePlugin();
})();
