// Sidebar — Figma Component — Generated by figma-sync
...
(async () => {
  ...
  if (components.length > 1) {
    ...
    components[0].name = "Sidebar";
  }

  figma.notify("✓ Sidebar: 4 variants created");
  figma.closePlugin();
})();
