// Breadcrumbs — Figma Component — Generated by figma-sync
...
(async () => {
  ...
  if (components.length > 1) {
    ...
    components[0].name = "Breadcrumbs";
  }

  figma.notify("✓ Breadcrumbs: 2 variants created");
  figma.closePlugin();
})();
