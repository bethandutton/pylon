// Hover Card — Figma Component — Generated by figma-sync
...
(async () => {
  ...
  if (components.length > 1) {
    ...
    components[0].name = "Hover Card";
  }

  figma.notify("✓ Hover Card: 4 variants created");
  figma.closePlugin();
})();
