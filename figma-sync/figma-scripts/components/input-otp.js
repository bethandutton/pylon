// Input Otp — Figma Component — Generated by figma-sync
...
(async () => {
  ...
  // Type=Filled, State=Default
  {
    const node = figma.createComponent();
    node.name = "Type=Filled, State=Default";
  ...
  {
    const node = figma.createComponent();
    node.name = "Type=Filled, State=Hover";
    node.layoutMode = "HORIZONTAL";
    node.primaryAxisSizingMode = "AUTO";
    node.counterAxisSizingMode = "AUTO";
    node.itemSpacing = 8;
  ...
  // Type=Filled, State=Disabled
  {
    const node = figma.createComponent();
    node.name = "Type=Filled, State=Disabled";
    node.layoutMode = "HORIZONTAL";
    node.primaryAxisSizingMode = "AUTO";
    node.counterAxisSizingMode = "AUTO";
    node.itemSpacing = 8;
  ...
  // Type=Filled, State=Focused
  {
    const node = figma.createComponent();
    node.name = "Type=Filled, State=Focused";
    node.layoutMode = "HORIZONTAL";
    node.primaryAxisSizingMode = "AUTO";
    node.counterAxisSizingMode = "AUTO";
    node.itemSpacing = 8;
  ...
  // Type=Filled, State=Invalid
  {
    const node = figma.createComponent();
    node.name = "Type=Filled, State=Invalid";
    node.layoutMode = "HORIZONTAL";
    node.primaryAxisSizingMode = "AUTO";
    node.counterAxisSizingMode = "AUTO";
    node.itemSpacing = 8;
  ...
  if (components.length > 1) {
    ...
    components[0].name = "Input Otp";
  }

  figma.notify("✓ Input Otp: 6 variants created");
  figma.closePlugin();
})();
