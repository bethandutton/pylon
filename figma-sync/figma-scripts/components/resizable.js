// Resizable — Figma Component — Generated by figma-sync
...
(async () => {
  ...
  if (components.length > 1) {
    ...
    components[0].name = "Resizable";
  }

  figma.notify("✓ Resizable: 4 variants created");
  figma.closePlugin();
})();
